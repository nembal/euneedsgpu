    ...
    <div className="space-y-32">
      <section className="relative flex flex-col items-center justify-center max-h-[66vh] min-h-[66vh] bg-blue-100">
        <div className="text-center animate-fadeIn">
          <p className="text-lg">AN OPEN LETTER</p>
        ...
        <div className="absolute bottom-0 w-full text-center pb-4">
          <p className="text-sm">Brought to you by BearMetal</p>
        </div>
      </section>
      <section className="max-w-2xl mx-auto space-y-4">
        <h2 className="text-xl font-bold">EU-Based Compute: The Foundation for AI Leadership in Europe</h2>
        <p>
          As a technology company deeply invested in Europe's future, we firmly believe that robust EU-based compute infrastructure is the bedrock upon which European AI innovation must be built. The two are inextricably linked – without significant local computing power, particularly GPU resources, there can be no meaningful AI development in the EU.
        </p>
        <p>
